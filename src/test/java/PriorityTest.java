...
class PriorityTest {
   ...
   @Test
   @DisplayName("let: code 'H' lookup to be Priority.HIGH")
   ...
   @Test
   @DisplayName("let: code 'M' lookup to be Priority.MEDIUM")
   ...
   @Test
   @DisplayName("let: code 'L' lookup to be Priority.LOW")
   ...
   @Test
   @DisplayName("let: code 'C' lookup be Priority.LOWEST")
   ...
   @Test
   @DisplayName("let: any other code lookup be Priority.LOWEST")
